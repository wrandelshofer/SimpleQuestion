/*
 * @(#)TitleElement.java  1.1  2006-10-11
 *
 ...
 * <p>
 * This data element describes the name given to the learning resource.
 * <p>
...
public class TitleElement extends AbstractElement {
    ...
    throws IOException, ParserConfigurationException, SAXException {
        if (! DOMs.isElement(elem, LOM.NS, "title")) {
            throw new IOException("'title' element expected, but found '"+elem.getTagName()+"' element.");
        }
