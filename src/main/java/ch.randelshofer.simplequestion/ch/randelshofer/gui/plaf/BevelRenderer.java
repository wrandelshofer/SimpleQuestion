...
g.fillRect(x, y, width, height);
            ...
            TexturePaint paint;
                if (VERBOSE) System.out.println("insets:"+imageInsets );
                if (VERBOSE) System.out.println("img dim w:"+imgWidth+" h:"+imgHeight);
                if (VERBOSE) System.out.println("cmp dim w:"+width+" h:"+height);

            if (top > 0 && left + right < width) {
                if (VERBOSE) System.out.println("  top:"+c.getClass()+" x"+left+" y"+0+" w"+(imgWidth - right - left)+" h"+top);
            ...
            if (bottom > 0 && left + right < width) {
                if (VERBOSE) System.out.println("  bottom:"+c.getClass()+" x"+left+" y"+(imgHeight - bottom)+" w"+(imgWidth - right - left)+" h"+bottom);
            ...
            if (left > 0 && top + bottom < height) {
                if (VERBOSE) System.out.println("  left:"+c.getClass()+" x"+0+" y"+top+" w"+(left)+" h"+(imgHeight - top - bottom));
            ...
            if (right > 0 && top + bottom < height) {
                if (VERBOSE) System.out.println("  right:"+c.getClass()+" x"+(imgWidth - right)+" y"+top+" w"+(right)+" h"+(imgHeight - top - bottom));
            ...
            if (left + right < width
            && top + bottom < height) {
                if (VERBOSE) System.out.println("  center:"+c.getClass()+" x"+(left)+" y"+top+" w"+(imgWidth - right - left)+" h"+(imgHeight - top - bottom));
