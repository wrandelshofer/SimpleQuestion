/*
 * @(#)KeywordElement.java  1.1  2006-10-11
 *
...
import org.w3c.dom.*;
/**
 * Represents a SCORM 1.2 LOM 'keyword' Element.
 * <p>
 * This data element describes keywords or phrases describing this learning 
 * resource. This data element should not be used for characteristics that can 
 * be described by other data elements.
 * <p>
...
public class KeywordElement extends AbstractElement {
    ...
    throws IOException, ParserConfigurationException, SAXException {
        if (! DOMs.isElement(elem, LOM.NS, "keyword")) {
            throw new IOException("'keyword' element expected, but found '"+elem.getTagName()+"' element.");
        }
