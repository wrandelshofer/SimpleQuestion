...
public class CourseModel extends DefaultTreeModel implements MutableTreeModel {
    ...
    throws IOException, SAXException, ParserConfigurationException  {
        ...
        try {
            ...
            if (entry == null) throw new FileNotFoundException("Couldn't find the entry 'imsmanifest.xml' in '"+inputPIF.getName()+"'.");
    ...
    throws IOException {
        ...
        try {
            ...
            in = null;
            try {
                in = new ZipInputStream(new BufferedInputStream(getClass().getResourceAsStream("/lmshtml.zip")));
    ...
    throws IOException {
        ...
        try {
            ...
            if (! isTOCVisible
                    ...
                    && ((ItemElement) getSelectedOrganization().getItemList().get(0)).getItemList().size() == 0) {
            ...
            w.flush();
            if (w.checkError()) throw new IOException("unable to write index.html");
        } finally {
            if (w != null) w.flush();
        }
    ...
    throws IOException {
        ...
        ZipInputStream in = new ZipInputStream(new BufferedInputStream(getClass().getResourceAsStream("/lmshtml.zip")));
        try {
            ZipEntry entry;
