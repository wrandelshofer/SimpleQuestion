/*
 * @(#)EntryElement.java  1.1  2006-10-11
 *
...
import org.w3c.dom.*;
/**
 * Represents a SCORM 1.2 LOM 'entry' Element.
 * <p>
 * This data element describes the actual string value of the entry within the
 * catalog.
 * <p>
 ...
 */
public class EntryElement extends AbstractElement {
    ...
    throws IOException, ParserConfigurationException, SAXException {
        if (! DOMs.isElement(elem, LOM.NS, "entry")) {
            throw new IOException("'entry' element expected, but found '"+elem.getTagName()+"' element.");
        }
